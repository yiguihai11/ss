...
set -e
apt-get -qq update
apt-get --yes install --no-install-recommends build-essential libncurses5-dev gcc libssl-dev grub2 bc bison flex git libelf-dev libxtables-dev ca-certificates rsync apt-utils grsync
