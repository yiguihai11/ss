...
env CARGO_HTTP_MULTIPLEXING=false cargo +nightly build --release --target x86_64-unknown-linux-gnu --features "aead-cipher-extra aead-cipher-2022 aead-cipher-2022-extra"
