...
#cd /tmp/libunwind
#autoreconf -i
#env CC="$TOOLCHAIN/bin/aarch64-linux-android${ANDROID_API}-clang" CXX="$TOOLCHAIN/bin/aarch64-linux-android${ANDROID_API}-clang++" LD=$TOOLCHAIN/bin/ld ./configure --host=aarch64-linux-android --prefix="/root/.rustup/toolchains/nightly-x86_64-unknown-linux-gnu/lib/rustlib/aarch64-linux-android" --disable-tests --disable-coredump
#make
#make install
#或者python2.7
...
#sed -i 's/\"fat\"/true/g' core/src/main/rust/shadowsocks-rust/Cargo.toml
