...
function GetOs()
{
    ...
    if (isset($OS)) {
        if (stripos($OS, "Android")) {
            return "Android";
        } elseif (stripos($OS, "iPhone")) {
            return "iPhone";
        } else {
            return "Other";
        }
...
if (file_exists($port_list)) {
    ...
    if ($bypass_app == "true" and GetOs() == "Android") {
        $android_list =
            file(
    ...
    foreach ($names as $name) {
        ...
        $used = $user_data[$server_port] ?? null;
        $percent = null;
        if (!is_numeric($used)) {
            $percent = " Offline";
        }
        ...
        if (is_array($android_list) and GetOs() == "Android") {
...
if (isset($udp_list) and GetOs() == "Android") {
    $i = 0;
